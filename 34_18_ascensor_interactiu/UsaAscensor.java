/*
	A java program in which an elevator starts in a user input floor and goes to the lowest one, but first going to the top one and then going to the lowest one
*/
