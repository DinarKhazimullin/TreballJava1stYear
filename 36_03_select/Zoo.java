/*
	A java class that works as a connection between a sqlite3 database and java classes. This time, we implement a class that returns a Category just by having its name.
*/
